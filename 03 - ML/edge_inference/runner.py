...
class EdgeInferenceRunner:
    def __init__(self,
        ...
        # Validate that configured patient exists in the patient registry (fail loudly if specified)
        if self.patient_id and not self.db.patient_exists(self.patient_id):
            raise RuntimeError(
